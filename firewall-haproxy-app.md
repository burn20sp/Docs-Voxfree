...
|---|---|---|---|
| `frontend-app-default` | 443 (HTTPS) | Recepciona todo o tráfego HTTPS da aplicação | Qualquer subdomínio de `voxfree.com` ou `voxfree.com.br`, ou domínio ACME configurado no Public Service, desde que sem regra explícita para outro destino |
